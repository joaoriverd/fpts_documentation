...
%\section{Recapitulation on existing analysis}
...
%In this section, we illustrate by means of an example that the best-case response time analysis for FPTS seems to not be an straight forward extension of the existing analysis, such as the best-case response time analysis for FPPS.
